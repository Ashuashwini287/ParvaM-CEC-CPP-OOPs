...
class Name{
    ...
    public:
        void setName(string n){
         ...
         void setDetails(string branch, int sem){ // As the parameter name and member name is same,it will assign the garbage value
            // To avoid the issue, we can use 'this' keyword to assign the parameter value to the private number
